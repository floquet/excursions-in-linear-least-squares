...
\section{Matrix Formulation}  %   SS   SS   SS   SS   SS   SS   SS   SS   SS   SS   SS   SS
...
Rank $\rho = 2$.
  \begin{equation*}   %  =   =   =   =   =
  %\begin{split}
    \bl{\mat{c}{a_{0} \\ a_{1}}_{LS}} = \bl{\Ap T} = \bl{\ur{*}\sbct{-1}\vr{} T}
    %\label{eq:}
  %\end{split}
  \end{equation*}

\section{Computing the SVD}  %   SS   SS   SS   SS   SS   SS   SS   SS   SS   SS   SS   SS
Solution steps
\begin{enumerate}
...
\subsection{Singular values}  %  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS
...
\subsection{Matrix for the domain}  %  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS
...
\subsection{Matrix for the codomain}  %  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS
...
\subsection{Error terms}  %  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS
...
\section{\label{sssec:archetype viz}Visualization}  %  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS  SSS
...
\begin{figure}[t]
	\begin{center}
		\includegraphics[ width = 3.5in ]{\pathgraphics "bevington plus"/svd/"bevington codomain"}
	\end{center}
...
\begin{figure}[t]
	\begin{center}
		\includegraphics[ width = 2.5in ]{\pathgraphics "bevington plus"/svd/"bevington domain"}
	\end{center}
...
\begin{table}[t]
	\begin{center}
		\begin{tabular}{ccccc}
		  ...
		  $\A{}$ & $ = $ & $\U{}$ & $\sig{}$ & $\V{*}$ \\
		  %
		  \includegraphics[ width = 1.5cm ]{\pathgraphics "bevington plus"/svd/"bevington poles"/A} &
		  \raisebox{25\height}=
		  &
