  ...
  \begin{table}[ht]  %  T A B L E
    ...
    \begin{center}
      \begin{tabular}{ccc}
        ...
        %
        $d = 0$ &
        \includegraphics[ width = 2.15in ]{\pathgraphics nonlinear/census/"fit order = 0"} &
        \includegraphics[ width = 2.15in ]{\pathgraphics nonlinear/census/"residuals 0"} \\[5pt]
        %
        $d = 1$ &
        \includegraphics[ width = 2.15in ]{\pathgraphics nonlinear/census/"fit order = 1"} &
        \includegraphics[ width = 2.15in ]{\pathgraphics nonlinear/census/"residuals 1"} \\[5pt]
        %
        $d = 2$ &
        \includegraphics[ width = 2.15in ]{\pathgraphics nonlinear/census/"fit order = 2"} &
        \includegraphics[ width = 2.15in ]{\pathgraphics nonlinear/census/"residuals 2"} \\[5pt]
        %
        $d = 3$ &
        \includegraphics[ width = 2.15in ]{\pathgraphics nonlinear/census/"fit order = 3"} &
        \includegraphics[ width = 2.15in ]{\pathgraphics nonlinear/census/"residuals 3"} \\
        %
      \end{tabular}
    \end{center}
  %\label{tab:?}
  ...
  \begin{table}[ht]  %  T A B L E
    ...
    \begin{center}
      \begin{tabular}{ccc}
        ...
        %
        $d = 4$ &
        \includegraphics[ width = 2.15in ]{\pathgraphics nonlinear/census/"fit order = 4"} &
        \includegraphics[ width = 2.15in ]{\pathgraphics nonlinear/census/"residuals 4"} \\[5pt]
        %
        $d = 5$ &
        \includegraphics[ width = 2.15in ]{\pathgraphics nonlinear/census/"fit order = 5"} &
